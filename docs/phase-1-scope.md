...
Minimum launchable scope for FilmComOS Phase 1, targeting the Yosemite Film Commission (YFC) pilot tenant. This is a tightening of the spec's own Phase 1 (Weeks 3–6 in `FilmComOS_YFC_Product_Spec_v2.docx` §9) — a launchable foundation that preserves the full-vision architecture without overcommitting.
